...
def file_upload_to_s3(doc, method):
    ...
    ignore_s3_upload_for_doctype = frappe.local.conf.get('ignore_s3_upload_for_doctype') or ['Remittance Meta Data Import','Data Import', 'Report', 'Prepared Report', 'WU Data Import', 'Western Union Data Import', 'User', 'Employee']
