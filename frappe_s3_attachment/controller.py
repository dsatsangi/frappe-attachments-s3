...
def file_upload_to_s3(doc, method):
    ...
    ignore_s3_upload_for_doctype = frappe.local.conf.get('ignore_s3_upload_for_doctype') or ['Data Import', 'Report', 'Prepared Report', 'Western Union Data Import', 'User', 'Employee']
